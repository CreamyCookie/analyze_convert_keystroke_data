...
class AlternatingPatternMatcher:
    def __init__(self, pattern: str, down_index: int = 0, key_index: int = 1):
        ...
        self.match_length = len(set(pattern))
...
if __name__ == '__main__':
    ...
    print(perm)
    expected = ['fFpPhnHN', 'fFpPhnNH', 'fFphPnHN', 'fFphPnNH', 'fpFPhnHN', 'fpFPhnNH', 'fpFhPnHN', 'fpFhPnNH',
    ...
    test_cases = [
        ...
        {  # h could be in any of 3 positions: first - X release is not part of the pattern
            'pattern': 'hnHNHxH',
            'events': [(True, 'h'), (True, 'n'), (False, 'h'), (False, 'n'), (True, 'x'), (False, 'x')],
            'start_index': 0,
            'expected': {'h': 0, 'n': 1, 'H': 2, 'N': 3, 'x': 4}
        },
        {  # h could be in any of 3 positions: second
            'pattern': 'hnHNHxH',
            'events': [(True, 'h'), (True, 'n'), (False, 'n'), (False, 'h'), (True, 'x'), (False, 'x')],
            'start_index': 0,
            'expected': {'h': 0, 'n': 1, 'N': 2, 'H': 3, 'x': 4}
        },
        {  # h could be in any of 3 positions: third
            'pattern': 'hnHNHxH',
            'events': [(True, 'h'), (True, 'n'), (False, 'n'), (True, 'x'), (False, 'h'), (False, 'x')],
            'start_index': 0,
        ...
        },
        {
            ...
            'events': [(True, 'f'), (False, 'f'), (True, 'p'), (False, 'p'), (True, 'h'),
                       (True, 'n'), (False, 'h'), (True, 'n')],  # the last n should be an up event (False)
            'start_index': 0,
            'expected': None
        },
        {  # actual: fFpPhnHN
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (False, 'f'), (True, 'p'), (False, 'p'), (True, 'h'), (True, 'n'), (False, 'h'),
                       (False, 'n')],
            'start_index': 0,
        ...
        {  # actual: fFpPhnNH
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (False, 'f'), (True, 'p'), (False, 'p'), (True, 'h'), (True, 'n'), (False, 'n'),
                       (False, 'h')],
            'start_index': 0,
        ...
        {  # actual: fFphPnHN
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (False, 'f'), (True, 'p'), (True, 'h'), (False, 'p'), (True, 'n'), (False, 'h'),
                       (False, 'n')],
            'start_index': 0,
        ...
        {  # actual: fFphPnNH
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (False, 'f'), (True, 'p'), (True, 'h'), (False, 'p'), (True, 'n'), (False, 'n'),
                       (False, 'h')],
            'start_index': 0,
        ...
        {  # actual: fpFPhnHN
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'f'), (False, 'p'), (True, 'h'), (True, 'n'), (False, 'h'),
                       (False, 'n')],
            'start_index': 0,
        ...
        {  # actual: fpFPhnNH
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'f'), (False, 'p'), (True, 'h'), (True, 'n'), (False, 'n'),
                       (False, 'h')],
            'start_index': 0,
        ...
        {  # actual: fpFhPnHN
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'f'), (True, 'h'), (False, 'p'), (True, 'n'), (False, 'h'),
                       (False, 'n')],
            'start_index': 0,
        ...
        {  # actual: fpFhPnNH
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'f'), (True, 'h'), (False, 'p'), (True, 'n'), (False, 'n'),
                       (False, 'h')],
            'start_index': 0,
        ...
        {  # actual: fpPFhnHN
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'p'), (False, 'f'), (True, 'h'), (True, 'n'), (False, 'h'),
                       (False, 'n')],
            'start_index': 0,
        ...
        {  # actual: fpPFhnNH
            'pattern': 'fFpFPFhPnHNH',
            'events': [(True, 'f'), (True, 'p'), (False, 'p'), (False, 'f'), (True, 'h'), (True, 'n'), (False, 'n'),
                       (False, 'h')],
            'start_index': 0,
        ...
        { # this one previously matched, so parts of the pattern where not found (which was a bug)
            ...
            'events': [(True, 'l'), (False, 'l'), (True, 'l'), (False, 'l'), (True, 'n'), (False, 'n')],
            'start_index': 0,
            'expected': None
        },
    ...
    for i, case in enumerate(test_cases):
        result = ''
        try:
            result = AlternatingPatternMatcher(case['pattern']).get_match(case['events'], case['start_index'])
